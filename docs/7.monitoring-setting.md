...
![ha1](/site/img/ha1.png)

```
3.選擇【熱門議題示警】。
```

![ha2](/site/img/ha2.png)
...
![ap1](/site/img/ap1.png)

```
2.連結到line登入畫面後，輸入Line帳號以及密碼並按下登入鍵。
```

![ap2](/site/img/ap2.png)

```
3.點選要接受通知的聊天室並按下同意連動。
```

![ap3](/site/img/ap3.png)

```
4.檢查Line聊天室中有無收道Line Notify連結。
```

![ap4](/site/img/ap4.png)
...
![tp1](/site/img/tp1.avif)

```
3.點選【+新增報告】。
```

![tp2](/site/img/tp2.png)
...
![tp3](/site/img/tp3.avif)
![tp4](/site/img/tp4.png)
